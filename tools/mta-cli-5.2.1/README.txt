...
Migration Toolkit for Applications by Red Hat (MTA) 5.2.1.Final is an extensible and customizable rule-based tool that helps simplify migration of Java applications.
